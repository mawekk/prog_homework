...
int main()
{
    ...
    printf("Length of the first vector = ", vectorLength(firstVector, size));
    printf("Length of the second vector = ", vectorLength(secondVector, size));

    printf("Scalar product of the vectors = ", scalarProduct(firstVector, secondVector, size));
